...
var messages = {
	...
	length: "The {_field_} must be {length} long",
...
var ValidationObserver = Vue.extend({
        ...
        ctx: function () {
            ...
            var ctx = {
                ...
                validate: function (arg) {
                    var promise = _this.validate(arg);
                    return {
                        then: function (thenable) {
    ...
    methods: {
        subscribe: function (subscriber, kind) {
            ...
            this.refs = Object.assign({}, this.refs, (_a = {}, _a[subscriber.vid] = subscriber, _a));
            this.refsByName = Object.assign({}, this.refsByName, (_b = {}, _b[subscriber.name] = subscriber, _b));
